...
var _ scraper = (*httpClientScraper)(nil)

func newHTTPClientScraper(pageURL string, query string) (*httpClientScraper, error) {
...
func (f *httpClientScraper) makeRequest() (*http.Request, error) {
...
func (f *httpClientScraper) url() *url.URL {
	return f.u
}

func (f *httpClientScraper) query() string {
	return f.q
}

func (f *httpClientScraper) getWatchedField() (target string, changed bool, err error) {
